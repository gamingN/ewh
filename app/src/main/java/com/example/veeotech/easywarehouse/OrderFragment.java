...
public class OrderFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener,ItemUpdateLisener{
    ...
    public ItemUpdateLisener itemUpdateLisener;
    @Override
    public void onAttach(Context context) {
        super.onAttach(context);
        Log.d("CWY","绑定"+context.getClass().getName());
    }
