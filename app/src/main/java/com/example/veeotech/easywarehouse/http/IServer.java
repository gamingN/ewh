...
//    Call<OrderBean> getOrderTest();
    ...
    @GET("enterEasyWh.php")
    Call<String> getZoneInfo(@Query("sku") String sku, @Query("aid") String aid,@Query("uid") String uid,@Query("brand") String brand);
    ...
    @GET("exitEasyWh.php")
    Call<String> getUpdateOut(@Query("sku") String sku,@Query("uid") String uid,@Query("brand") String brand,@Query("aid") String aid);
    ...
    @GET("selectEasyWh.php")
    Call<WarehouseBean> getEasyWhCount(@Query("sku") String sku);
