...
public class ChuFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_chu, container, false);

        bt_checktwo_chu = (Button) view.findViewById(R.id.bt_erwei_chu);
        bt_checkone_chu = (Button) view.findViewById(R.id.bt_tiaoxing_chu);
                        ...
                        .subscribe(new Action1<Boolean>() {
                            ...
                            public void call(Boolean aBoolean) {
                                if (aBoolean) {//true表示获取权限成功（注意这里在android6.0以下默认为true）
                                    new ScannerUtil(ChuFragment.this, integrator).selectTwo();
                                } else {
            ...
            public void onClick(View v) {
                RxPermissions.getInstance(getActivity())
                        ...
                        .subscribe(new Action1<Boolean>() {
                            ...
                            public void call(Boolean aBoolean) {
                                if (aBoolean) {//true表示获取权限成功（注意这里在android6.0以下默认为true）
                                    new ScannerUtil(ChuFragment.this, integrator).selectOne();
                                } else {
                                    Toast.makeText(getActivity(), "沒有權限", Toast.LENGTH_SHORT).show();
                                }
                            }
